...
export type LocalizedString = { ko: string; en: string; ja: string; es: string; pt: string };
    ...
    results: [
      {
        ...
        recommendedTests: ['hidden-personality-test', 'how-friends-see-me-test', 'intuition-vs-logic-test'],
        relationshipStyle: { ko: '연애도 목표를 정하고 전략적으로 접근합니다. 표현은 직접적이지만 책임감 하나만큼은 완벽하고, 상대방이 인정해줄 때 더 깊이 헌신해요.', en: 'Approaches love with strategy and clear goals. Direct in expression but deeply devoted—thrives when a partner recognizes their dedication.', ja: '恋愛も目標を持って戦略的に取り組みます。表現は直接的ですが責任感は完璧で、認めてもらえるほど深く献身します。', es: 'Aborda el amor con estrategia y metas claras. Directo en la expresión pero profundamente comprometido cuando su pareja lo reconoce.', pt: 'Aborda o amor com estratégia e metas claras. Direto na expressão mas profundamente comprometido quando o parceiro o reconhece.' },
        compatibleVibe: { ko: 'INFP, INTP — 나의 강한 방향성을 부드럽게 채워줄 유형과 잘 맞아요', en: 'INFP, INTP — Types who gently balance your strong drive with warmth and flexibility', ja: 'INFP, INTP — 強い方向性を優しく補ってくれるタイプと相性◎', es: 'INFP, INTP — Tipos que equilibran suavemente tu fuerte sentido de dirección', pt: 'INFP, INTP — Tipos que equilibram suavemente o seu forte senso de direção' }
      },
      {
        key: 'ENTP',
        ...
        relationshipStyle: { ko: '지적 대화와 논쟁을 즐기는 연애 스타일. 다양한 이야기를 나눌 수 있는 관계에서 가장 빛납니다.', en: 'Loves intellectual debate and stimulating conversation in relationships. Shines brightest with a partner who can keep up mentally.', ja: '知的な会話や議論を楽しむ恋愛スタイル。様々な話ができる関係で最も輝きます。', es: 'Disfruta del debate intelectual en el amor. Brilla más con una pareja que pueda seguir su ritmo mental.', pt: 'Disfruta do debate intelectual no amor. Brilha mais com um parceiro que consiga acompanhar seu ritmo mental.' },
        compatibleVibe: { ko: 'INFJ, INTJ — 나의 발산적 에너지를 수렴해줄 깊이 있는 유형과 잘 어울려요', en: 'INFJ, INTJ — Deep thinkers who channel your scattered energy into focus', ja: 'INFJ, INTJ — 発散するエネルギーを収束させてくれる深みのあるタイプ', es: 'INFJ, INTJ — Pensadores profundos que canalizan tu energía dispersa', pt: 'INFJ, INTJ — Pensadores profundos que canalizam a sua energia dispersa' }
      },
      {
        key: 'ENFJ',
      ...
      },
      {
        ...
        relationshipStyle: { ko: '헌신적이고 따뜻한 연인. 기념일을 절대 잊지 않으며 상대방이 편안하게 느낄 수 있도록 늘 세심하게 노력합니다.', en: 'Devoted and warm. Never forgets anniversaries and always works to make a partner feel comfortable and loved.', ja: '献身的で温かい恋人。記念日は絶対に忘れず、相手が心地よくいられるよう細やかに気遣います。', es: 'Amante dedicado y cálido. Nunca olvida los aniversarios y siempre se esfuerza por hacer sentir cómoda a su pareja.', pt: 'Amante dedicado e caloroso. Nunca esquece os aniversários e sempre se esforça para fazer o parceiro se sentir confortável.' },
        compatibleVibe: { ko: 'ISFP, INFP — 나의 헌신에 감동받고 진심으로 화답하는 감성형과 잘 맞아요', en: 'ISFP, INFP — Emotional types genuinely moved by your devotion who respond wholeheartedly', ja: 'ISFP, INFP — 献身に感動し、心から応えてくれる感性豊かなタイプ', es: 'ISFP, INFP — Tipos sensibles que se conmueven de verdad con tu entrega y responden con el corazón', pt: 'ISFP, INFP — Tipos sensíveis que se emocionam de verdade com o seu carinho genuíno' }
      },
      {
        key: 'ESTP',
      ...
      },
      {
        ...
        relationshipStyle: { ko: '관계에 신중하게 접근하지만 한번 마음을 열면 깊고 진지한 연인이 됩니다. 말보다 행동으로 사랑을 표현하는 타입이에요.', en: 'Cautious about relationships, but once open, becomes a deeply devoted partner. Expresses love through actions, not words.', ja: '関係には慎重ですが、心を開いたら深く真剣な恋人に。言葉より行動で愛情を表現するタイプです。', es: 'Cauteloso en las relaciones, pero una vez abierto, se convierte en una pareja profundamente comprometida. Expresa el amor con hechos, no palabras.', pt: 'Cauteloso nos relacionamentos, mas uma vez aberto, torna-se um parceiro confiável para a vida toda.' },
        compatibleVibe: { ko: 'ENFP, ENTP — 나의 닫힌 세계를 밝고 창의적으로 열어줄 유형과 잘 맞아요', en: 'ENFP, ENTP — Types who creatively and cheerfully open up your closed world', ja: 'ENFP, ENTP — 閉じた世界を明るく創造的に開いてくれるタイプ', es: 'ENFP, ENTP — Tipos que abren tu mundo cerrado de manera creativa y alegre', pt: 'ENFP, ENTP — Tipos que abrem o seu mundo fechado de forma criativa' }
      },
      {
        key: 'INTP',
      ...
      },
      {
        ...
        recommendedTests: ['attachment-style-test', 'hidden-personality-test', 'love-style-test'],
        relationshipStyle: { ko: '깊고 의미 있는 연결을 원하며 표면적인 관계는 금방 지루해집니다. 진심이 통하는 사람을 만나면 온 마음을 다해 헌신해요.', en: 'Craves deep, meaningful connection and grows bored quickly with superficiality. Gives everything to someone who truly understands.', ja: '深く意味のある繋がりを求め、表面的な関係はすぐに飽きます。本当に心が通じる人には全力で献身します。', es: 'Anhela conexiones profundas; se aburre rápido de lo superficial. Se entrega por completo a quien lo comprende de verdad.', pt: 'Anseia conexões profundas; fica entediado rapidamente com o superficial.' },
        compatibleVibe: { ko: 'ENFP, ENTP — 나의 진지함을 가볍고 따뜻하게 받아줄 유형과 잘 맞아요', en: 'ENFP, ENTP — Types who receive your seriousness with warmth and lightness', ja: 'ENFP, ENTP — 真剣さを軽やかに温かく受け止めてくれるタイプ', es: 'ENFP, ENTP — Tipos que reciben tu seriedad con calidez y ligereza', pt: 'ENFP, ENTP — Tipos que recebem a sua seriedade com calor e leveza' }
      },
      {
        key: 'INFP',
        ...
        relationshipStyle: { ko: '사랑하면 온 마음을 주는 유형. 진심과 감정을 중시하고 관계에서 깊은 유대와 이해를 원합니다.', en: 'Gives everything when in love. Values sincerity and emotion, seeking deep bonds and mutual understanding above all.', ja: '愛すると全てを捧げるタイプ。誠実さと感情を大切にし、深い絆と理解を求めます。', es: 'Lo da todo cuando ama. Valora la sinceridad y la emoción, buscando vínculos profundos y comprensión mutua.', pt: 'Dá tudo de si quando ama. Valoriza a sinceridade e a emoção, buscando laços profundos e compreensão mútua.' },
        compatibleVibe: { ko: 'ENFJ, ENTJ — 나를 이해하고 세상을 헤쳐나가도록 이끌어줄 리더형과 잘 맞아요', en: 'ENFJ, ENTJ — Leaders who understand you and guide you confidently through the world', ja: 'ENFJ, ENTJ — 理解してくれ、世界を共に切り開いてくれるリーダータイプ', es: 'ENFJ, ENTJ — Líderes que te comprenden y te guían con confianza por el mundo', pt: 'ENFJ, ENTJ — Líderes que o compreendem e o guiam com confiança pelo mundo' }
      },
      {
        key: 'ISTJ',
      ...
      },
      {
        ...
        recommendedTests: ['love-style-test', 'attachment-style-test', 'how-friends-see-me-test'],
        relationshipStyle: { ko: '깊은 헌신과 세심함으로 상대방을 감동시키는 연인. 소소한 기념일도 기억하고 진심으로 챙깁니다.', en: 'Moves a partner with deep devotion and attention to detail. Remembers even small anniversaries and celebrates them sincerely.', ja: '深い献身と細やかさで相手を感動させる恋人。小さな記念日も覚えて心から大切にします。', es: 'Conmueve a su pareja con dedicación profunda y atención al detalle. Recuerda hasta los pequeños aniversarios y los celebra de corazón.', pt: 'Comove o parceiro com dedicação profunda e atenção aos detalhes. Lembra até os pequenos aniversários.' },
        compatibleVibe: { ko: 'ESTP, ESFP — 나의 조용함을 밝고 활기차게 채워줄 유형과 잘 어울려요', en: 'ESTP, ESFP — Bright, energetic types who fill your quietness with life', ja: 'ESTP, ESFP — 静けさを明るく活気よく満たしてくれるタイプ', es: 'ESTP, ESFP — Tipos brillantes y enérgicos que llenan tu quietud con vida', pt: 'ESTP, ESFP — Tipos brilhantes e energéticos que preenchem a sua quietude com vida' }
      },
      {
        key: 'ISTP',
        ...
        recommendedTests: ['intuition-vs-logic-test', 'hidden-personality-test', 'over-immersion-test'],
        relationshipStyle: { ko: '자유를 중시하는 연애 스타일. 말보다 행동으로 챙기며 상대방의 독립성도 존중하는 여유로운 파트너예요.', en: "Values freedom in love. Cares through actions over words and genuinely respects a partner's independence.", ja: '自由を重視する恋愛スタイル。言葉より行動でケアし、相手の独立性も尊重するゆとりあるパートナーです。', es: 'Valora la libertad en el amor. Cuida con acciones más que palabras y respeta genuinamente la independencia de su pareja.', pt: 'Valoriza a liberdade no amor. Cuida com ações mais do que palavras e respeita a independência do parceiro.' },
        compatibleVibe: { ko: 'ESFJ, ESTJ — 나의 방향성 없는 일상을 따뜻하게 정리해줄 계획형과 잘 어울려요', en: 'ESFJ, ESTJ — Planners who warmly bring order to your directionless daily life', ja: 'ESFJ, ESTJ — 方向性のない日常を温かく整理してくれる計画型タイプ', es: 'ESFJ, ESTJ — Planificadores que ordenan calurosamente tu vida cotidiana', pt: 'ESFJ, ESTJ — Planejadores que organizam calorosamente a sua vida cotidiana' }
      },
      {
        key: 'ISFP',
