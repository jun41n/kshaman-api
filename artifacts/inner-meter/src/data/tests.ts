...
const _tests: Test[] = [
  ...
  {
    slug: 'sbti-test',
    title: 'SBTI — 나는 어떤 찐또배기 유형?',
    description: '27가지 황당한 성격 유형 중 나는 과연 어느 쪽일까? MZ세대의 민낯을 분석해 드립니다 🃏',
    category: '재미 테스트',
    estimatedTime: '5분',
    emoji: '🃏',
    questions: [
      {
        id: 1,
        text: '친구들이 어디 갈지 못 정하고 있을 때 나는?',
        options: [
          { label: '내가 그냥 정해버린다. 빨리빨리', scores: { ctrl: 2 } },
          { label: '선택지 2~3개 추천하고 다수결로 정한다', scores: { ctrl: 1 } },
          { label: '아무 데나 괜찮다고 한다', scores: { ctrl: 0 } },
          { label: '그냥 집에 있겠다 한다', scores: { ctrl: 0 } },
        ],
      },
      {
        id: 2,
        text: '모둠 과제에서 내 역할은?',
        options: [
          { label: '당연히 조장이죠', scores: { ctrl: 2 } },
          { label: '핵심 파트 담당하며 팀원 독려', scores: { ctrl: 1 } },
          { label: '뭐든 시키는 것 함', scores: { ctrl: 0 } },
          { label: '내가 뭐 했더라... 기억이 안 남', scores: { ctrl: 0 } },
        ],
      },
      {
        id: 3,
        text: '처음 가는 식당에서?',
        options: [
          { label: '가기 전에 메뉴 미리 파악함', scores: { ctrl: 2 } },
          { label: '가서 인기 메뉴 추천해줌', scores: { ctrl: 1 } },
          { label: '옆 사람 따라 시킴', scores: { ctrl: 0 } },
          { label: '메뉴 고르는 게 제일 힘듦', scores: { ctrl: 0 } },
        ],
      },
      {
        id: 4,
        text: '어떤 일이 잘못되면?',
        options: [
          { label: '내가 나서서 수습한다', scores: { ctrl: 2 } },
          { label: '해결책을 조용히 제시한다', scores: { ctrl: 1 } },
          { label: '걱정만 하다 누군가가 해결해주길 기다린다', scores: { ctrl: 0 } },
          { label: '나는 모르는 일이다', scores: { ctrl: 0 } },
        ],
      },
      {
        id: 5,
        text: '여행 계획 세우는 역할은?',
        options: [
          { label: '분 단위 계획표 내가 만든다', scores: { ctrl: 2 } },
          { label: '대략적인 틀은 내가 잡아준다', scores: { ctrl: 1 } },
          { label: '플랜 B나 생각해둠', scores: { ctrl: 0 } },
          { label: '그냥 따라감', scores: { ctrl: 0 } },
        ],
      },
      {
        id: 6,
        text: '회의나 모임에서 내 자리는?',
        options: [
          { label: '중앙이 자연스럽게 내 자리', scores: { ctrl: 2 } },
          { label: '발언은 하는 편', scores: { ctrl: 1 } },
          { label: '아무 데나 앉음', scores: { ctrl: 0 } },
          { label: '구석구석 or 그냥 안 감', scores: { ctrl: 0 } },
        ],
      },
      {
        id: 7,
        text: '친구가 나쁜 선택을 하려 할 때?',
        options: [
          { label: '"그거 하지 마" 하고 바로 말린다', scores: { ctrl: 2 } },
          { label: '한 번은 얘기해주고 결국 네 선택이라고 한다', scores: { ctrl: 1 } },
          { label: '걱정은 되지만 말 못 함', scores: { ctrl: 0 } },
          { label: '뭐... 알아서 해', scores: { ctrl: 0 } },
        ],
      },
      {
        id: 8,
        text: '집에서 리모컨은?',
        options: [
          { label: '내 손에 있다', scores: { ctrl: 2 } },
          { label: '그때그때 상황 봐서', scores: { ctrl: 1 } },
          { label: 'TV 보는 사람이 가지면 됨', scores: { ctrl: 0 } },
          { label: 'TV를 안 봄', scores: { ctrl: 0 } },
        ],
      },
      {
        id: 9,
        text: '줄을 서야 하는 상황에서?',
        options: [
          { label: '앞 사람이 너무 느리면 한 마디 한다', scores: { ctrl: 2 } },
          { label: '속으로는 답답해도 그냥 기다린다', scores: { ctrl: 1 } },
          { label: '기다리면서 딴 생각함', scores: { ctrl: 0 } },
          { label: '그냥 포기하고 안 먹고 간다', scores: { ctrl: 0 } },
        ],
      },
      {
        id: 10,
        text: '모임에서 낯선 사람이 틀린 말을 하면?',
        options: [
          { label: '바로 반박한다', scores: { ctrl: 2 } },
          { label: '조용히 틀렸다고 말해준다', scores: { ctrl: 1 } },
          { label: '그냥 무시함', scores: { ctrl: 0 } },
          { label: '눈치 보며 동조하는 척함', scores: { ctrl: 0 } },
        ],
      },
      {
        id: 11,
        text: '친구가 힘들다고 하면?',
        options: [
          { label: '새벽에도 달려간다', scores: { warm: 2 } },
          { label: '전화해서 다 들어준다', scores: { warm: 1 } },
          { label: '"힘내" 카톡 보낸다', scores: { warm: 0 } },
          { label: '이모지 하나 보낸다', scores: { warm: 0 } },
        ],
      },
      {
        id: 12,
        text: '내 지갑은?',
        options: [
          { label: '친구들한테 자주 열린다', scores: { warm: 2 } },
          { label: '내 거 살 때 가끔 사줌', scores: { warm: 1 } },
          { label: '더치페이가 제일 공평함', scores: { warm: 0 } },
          { label: '내 거 사기도 빠듯함', scores: { warm: 0 } },
        ],
      },
      {
        id: 13,
        text: '길 잃은 외국인이 나에게 묻는다면?',
        options: [
          { label: '같이 목적지까지 데려다준다', scores: { warm: 2 } },
          { label: '검색해서 친절히 알려준다', scores: { warm: 1 } },
          { label: '영어가 안 되는 척한다', scores: { warm: 0 } },
          { label: '이어폰 끼고 못 들은 척한다', scores: { warm: 0 } },
        ],
      },
      {
        id: 14,
        text: '친구가 시킨 음식이 양이 너무 많다면?',
        options: [
          { label: '"나눠줄까?" 먼저 물어본다', scores: { warm: 2 } },
          { label: '부탁하면 같이 먹어준다', scores: { warm: 1 } },
          { label: '내 것만 먹는다', scores: { warm: 0 } },
          { label: '남기면 싸 가라고 한다', scores: { warm: 0 } },
        ],
      },
      {
        id: 15,
        text: '생일 챙기기는?',
        options: [
          { label: '친구 생일 며칠 전부터 준비한다', scores: { warm: 2 } },
          { label: '당일에 꼭 연락한다', scores: { warm: 1 } },
          { label: '생각나면 한다', scores: { warm: 0 } },
          { label: '내 생일도 모르겠다', scores: { warm: 0 } },
        ],
      },
      {
        id: 16,
        text: '직장 동료가 실수했을 때?',
        options: [
          { label: '"내가 도와줄게" 하고 같이 해결한다', scores: { warm: 2 } },
          { label: '어디서 막혔는지 알려준다', scores: { warm: 1 } },
          { label: '내 일이나 잘 하면 됨', scores: { warm: 0 } },
          { label: '잘됐다 싶다', scores: { warm: 0 } },
        ],
      },
      {
        id: 17,
        text: '소개팅 상대가 별로일 때?',
        options: [
          { label: '그래도 자리를 즐겁게 만들어준다', scores: { warm: 2 } },
          { label: '무난하게 마무리한다', scores: { warm: 1 } },
          { label: '빨리 끝내고 집에 간다', scores: { warm: 0 } },
          { label: '화장실 간다고 하고 도망간다', scores: { warm: 0 } },
        ],
      },
      {
        id: 18,
        text: '엘리베이터에서 어르신이 타실 때?',
        options: [
          { label: '열림 버튼 누르고 층수도 눌러드린다', scores: { warm: 2 } },
          { label: '열림 버튼 정도는 누른다', scores: { warm: 1 } },
          { label: '타신 것 확인하고 그냥 닫는다', scores: { warm: 0 } },
          { label: '이미 문이 닫혔다', scores: { warm: 0 } },
        ],
      },
      {
        id: 19,
        text: '친구가 나에게 도움을 요청할 때?',
        options: [
          { label: '무조건 도와준다, 당연하지!', scores: { warm: 2 } },
          { label: '내가 할 수 있는 범위 안에서 도와준다', scores: { warm: 1 } },
          { label: '상황 봐서 결정한다', scores: { warm: 0 } },
          { label: '이런저런 이유로 못 한다', scores: { warm: 0 } },
        ],
      },
      {
        id: 20,
        text: '마지막 남은 음식을 앞에 두고?',
        options: [
          { label: '"먹을 사람?" 하고 먼저 양보한다', scores: { warm: 2 } },
          { label: '다들 눈치 보길래 내가 대신 먹어준다', scores: { warm: 1 } },
          { label: '그냥 내가 먹는다', scores: { warm: 0 } },
          { label: '먹지도 않고 그냥 둔다', scores: { warm: 0 } },
        ],
      },
      {
        id: 21,
        text: '처음 만난 모임에서 나는?',
        options: [
          { label: '5분 안에 모두와 친해진다', scores: { social: 2 } },
          { label: '적극적으로 먼저 말을 건다', scores: { social: 1 } },
          { label: '말 걸어줄 사람을 기다린다', scores: { social: 0 } },
          { label: '조용히 있다가 집에 간다', scores: { social: 0 } },
        ],
      },
      {
        id: 22,
        text: 'SNS를 얼마나 하나?',
        options: [
          { label: '일상 다 올리고 팔로워 관리도 함', scores: { social: 2 } },
          { label: '가끔 올리고 친구 것만 봄', scores: { social: 1 } },
          { label: '받아만 봄', scores: { social: 0 } },
          { label: 'SNS 없음', scores: { social: 0 } },
        ],
      },
      {
        id: 23,
        text: '노래방에서 내 포지션은?',
        options: [
          { label: '마이크 절대 안 놓는 편', scores: { social: 2 } },
          { label: '잘 부르진 않아도 분위기 살림', scores: { social: 1 } },
          { label: '그냥 앉아서 박수', scores: { social: 0 } },
          { label: '노래방 안 감', scores: { social: 0 } },
        ],
      },
      {
        id: 24,
        text: '파티나 큰 모임에 갔을 때?',
        options: [
          { label: '모르는 사람에게도 먼저 말 건다', scores: { social: 2 } },
          { label: '아는 사람 위주로 어울린다', scores: { social: 1 } },
          { label: '구석에서 핸드폰 보고 있음', scores: { social: 0 } },
          { label: '파티를 안 감', scores: { social: 0 } },
        ],
      },
      {
        id: 25,
        text: '오늘 있었던 재밌는 일을?',
        options: [
          { label: '바로 카톡으로 친구들에게 공유', scores: { social: 2 } },
          { label: '가까운 친구 1~2명에게 말한다', scores: { social: 1 } },
          { label: '혼자 일기에 쓴다', scores: { social: 0 } },
          { label: '그냥 잊어버린다', scores: { social: 0 } },
        ],
      },
      {
        id: 26,
        text: '밖에서 아는 사람을 발견했을 때?',
        options: [
          { label: '먼저 반갑게 달려가서 인사한다', scores: { social: 2 } },
          { label: '눈 마주치면 인사한다', scores: { social: 1 } },
          { label: '못 본 척한다', scores: { social: 0 } },
          { label: '숨는다', scores: { social: 0 } },
        ],
      },
      {
        id: 27,
        text: '단톡방에서 나는?',
        options: [
          { label: '대화 주도하고 분위기 메이커', scores: { social: 2 } },
          { label: '호응은 잘 해준다', scores: { social: 1 } },
          { label: '읽기는 함', scores: { social: 0 } },
          { label: '알림 꺼놓음', scores: { social: 0 } },
        ],
      },
      {
        id: 28,
        text: '처음 보는 사람에게 말 걸기가?',
        options: [
          { label: '쉽다! 오히려 재밌다', scores: { social: 2 } },
          { label: '노력하면 된다', scores: { social: 1 } },
          { label: '좀 어색하지만 할 수는 있다', scores: { social: 0 } },
          { label: '절대 못 한다', scores: { social: 0 } },
        ],
      },
      {
        id: 29,
        text: '사람이 많은 곳에 있을 때?',
        options: [
          { label: '에너지가 넘친다!', scores: { social: 2 } },
          { label: '괜찮다, 별로 신경 안 씀', scores: { social: 1 } },
          { label: '빨리 집에 가고 싶다', scores: { social: 0 } },
          { label: '그냥 공황이 온다', scores: { social: 0 } },
        ],
      },
      {
        id: 30,
        text: '오늘 하루 일정이 없다면?',
        options: [
          { label: '즉흥으로 누군가를 불러낸다', scores: { social: 2 } },
          { label: '계획 있는 친구와 함께한다', scores: { social: 1 } },
          { label: '혼자 뭔가를 즐긴다', scores: { social: 0 } },
          { label: '아무것도 안 한다', scores: { social: 0 } },
        ],
      },
    ],
    results: [
      {
        key: 'mum',
        title: 'MUM — 우리 집 엄마형',
        summary: '나보고 엄마라고 불러도 돼?',
        description: '주변 사람을 챙기고, 리더십도 있고, 사람들이랑도 잘 어울리는 완벽한 엄마형 인간입니다. 친구들의 배고픔, 외로움, 약속 관리까지 모두 당신 몫이에요. 아마 지갑에는 언제나 물티슈와 여분의 충전기가 있겠죠. 당신이 없으면 이 모임 무너져요.',
        strengths: ['배려심이 남다름', '자연스러운 리더십', '사람들이 믿고 따름'],
        caution: ['남 챙기다 본인 번아웃 주의', '고마운 줄 모르는 사람 조심'],
        shareText: '내 SBTI 유형은 MUM — 우리 집 엄마형이래! 너는 뭐야?',
        recommendedTests: ['how-friends-see-me-test', 'love-style-test', 'teto-egen-test'],
      },
      {
        key: 'boss',
        title: 'BOSS — 어? 내가 리더야?',
        summary: '일단 내가 이야기해 볼게요',
        description: '조용히 앞에 나서는 타입. 강요한 것도 아닌데 어느 순간 팀장이 되어 있고, 회의 때 말하면 다들 조용해집니다. 따뜻하지만 결정할 때는 칼 같아요. 친한 친구들한테는 한없이 챙겨주는데 모르는 사람한테는 다소 무서워 보일 수 있어요.',
        strengths: ['자연스러운 리더십', '따뜻한 결단력', '신뢰받는 분위기'],
        caution: ['혼자 너무 많이 짊어지려 함', '가끔 리더 안 해도 됨'],
        shareText: '내 SBTI 유형은 BOSS — 어? 내가 리더야?래! 너는 뭐야?',
        recommendedTests: ['mbti-test', 'hidden-personality-test', 'teto-egen-test'],
      },
      {
        key: 'ctrl',
        title: 'CTRL — 장악자',
        summary: '다 내가 할게요',
        description: '모든 것을 혼자서 통제하고 싶은 유형. 다른 사람에게 맡기면 불안해서 결국 다 직접 해버리는 스타일이에요. 효율은 최상이지만 번아웃도 최상입니다. 주변 사람이 고마우면서도 숨막혀하는 이중적인 감정을 느끼고 있어요. Ctrl+Z가 없는 현실이 제일 무서운 유형.',
        strengths: ['책임감 갑', '완성도 높은 결과물', '믿을 수 있는 사람'],
        caution: ['번아웃 주의', '가끔은 맡겨도 됨'],
        shareText: '내 SBTI 유형은 CTRL — 장악자래! 너는 뭐야?',
        recommendedTests: ['villain-type-test', 'mbti-test', 'teto-egen-test'],
      },
      {
        key: 'thank-k',
        title: 'THAN-K — 감사쟁이',
        summary: '감사합니다, 진심입니다',
        description: '이 세상에서 가장 예의 바른 유형. 편의점 알바한테도 "감사합니다" 하는 사람이에요. 인싸력도 있고 사람들을 이끌기도 하는데, 진짜로 주변에 감사한 마음이 넘쳐서 나오는 것임. 모임에서 제일 먼저 손들고 "제가 할게요!" 하는 사람.',
        strengths: ['긍정 에너지', '사람들이 좋아함', '성실함'],
        caution: ['착함이 무기가 될 수 있음', '가끔 이용당하지 않도록 주의'],
        shareText: '내 SBTI 유형은 THAN-K — 감사쟁이래! 너는 뭐야?',
        recommendedTests: ['how-friends-see-me-test', 'love-language-test', 'teto-egen-test'],
      },
      {
        key: 'love-r',
        title: 'LOVE-R — 연애뇌',
        summary: '오늘도 연애 생각만 5시간',
        description: '이 테스트를 하는 동안에도 그 사람 생각 한 번쯤 했죠? 나서는 편이라 고백도 잘 하고, 연애에 올인하는 스타일. 연락 안 오면 뭐 하나 훤히 알고 싶고, 상대방 SNS 1년 전 게시물까지 다 봤음. 사랑할 때는 온 우주가 그 사람이에요.',
        strengths: ['감정 표현 풍부', '배려심 있음', '연애에 진심'],
        caution: ['연애에 너무 올인', '본인도 챙기세요'],
        shareText: '내 SBTI 유형은 LOVE-R — 연애뇌래! 너는 뭐야?',
        recommendedTests: ['love-style-test', 'attachment-style-test', 'love-language-test'],
      },
      {
        key: 'oh-no',
        title: 'OH-NO — 걱정이',
        summary: '어... 그게 잘 될까?',
        description: '모든 일에 시나리오 B, C, D를 미리 준비해두는 걱정 전문가. 나서는 편인데 나선 다음에 "아 내가 잘 할 수 있을까..." 걱정하는 타입이에요. 잠 못 자고 뒤척이는 밤이 많고, 괜찮다고 말하면서 속으로는 전혀 안 괜찮음. 근데 다 잘 하거든요? 그게 아이러니야.',
        strengths: ['준비성 철저', '실수 적음', '세심함'],
        caution: ['걱정이 에너지 낭비', '이미 잘 하고 있음'],
        shareText: '내 SBTI 유형은 OH-NO — 걱정이래! 너는 뭐야?',
        recommendedTests: ['hidden-personality-test', 'attachment-style-test', 'teto-egen-test'],
      },
      {
        key: 'brag',
        title: 'BRAG — 자랑쟁이',
        summary: '오늘 있었던 일 들어봐!',
        description: '뭔가 좋은 일 있으면 5분 안에 전체 단톡에 공유해야 직성이 풀리는 타입. SNS 업데이트도 기본이고요. 나쁜 게 아니에요 — 그냥 삶을 즐길 줄 알고 나눌 줄 아는 것이죠. 다만 듣는 사람이 가끔 지칠 수는 있음. 그래도 자기 자신에 대한 자신감은 최상이에요.',
        strengths: ['자신감', '에너지 넘침', '자기 PR 능력'],
        caution: ['주변 반응 읽는 연습', '자랑도 타이밍이 있음'],
        shareText: '내 SBTI 유형은 BRAG — 자랑쟁이래! 너는 뭐야?',
        recommendedTests: ['narcissist-test', 'villain-type-test', 'teto-egen-test'],
      },
      {
        key: 'flex',
        title: 'FLEX — 과시왕',
        summary: '이거 얼마짜리인지 알아?',
        description: '좋은 것에 대한 욕망이 확실한 유형. 명품이든 경험이든 "최고"를 선호하고, 그걸 보여주고 싶은 마음도 숨기지 않아요. 사실 본인도 그게 문제라는 걸 알면서도 지갑이 먼저 열림. 카드값 명세서가 올 때마다 잠깐 반성하지만 오늘 또 장바구니에 뭔가 담겨 있는 중.',
        strengths: ['삶의 질에 투자할 줄 앎', '솔직함', '트렌드에 밝음'],
        caution: ['통장 잔고 확인하기', '과시가 관계에 영향 줄 수 있음'],
        shareText: '내 SBTI 유형은 FLEX — 과시왕이래! 너는 뭐야?',
        recommendedTests: ['narcissist-test', 'love-style-test', 'teto-egen-test'],
      },
      {
        key: 'rage',
        title: 'RAGE — 분노조절형',
        summary: '아 진짜요?? 아 진짜~',
        description: '참을 만큼 참았다가 한 번에 터지는 유형. 주변 사람이 "얘는 무서워..." 하면서도 묘하게 의지하는 인물. 실수한 사람이 제일 무서워하는 사람이 당신이에요. 근데 사실 화가 나는 건 그 상황이 답답해서, 즉 기준이 높기 때문이에요. 열정의 다른 이름이 분노일 때가 많아요.',
        strengths: ['기준이 높음', '정의감', '추진력'],
        caution: ['쿨다운 시간 필요', '분노 표현 방식 조절'],
        shareText: '내 SBTI 유형은 RAGE — 분노조절형이래! 너는 뭐야?',
        recommendedTests: ['villain-type-test', 'psychopath-test', 'teto-egen-test'],
      },
      {
        key: 'gogo',
        title: 'GOGO — 행동파',
        summary: '일단 해! 생각은 뛰면서!',
        description: '말이 나오기 무섭게 이미 시작한 사람. 계획? 그거 뛰면서 세우면 됨. 남들이 "이게 될까?" 할 때 당신은 이미 반 쯤 완성되어 있어요. 친화력도 있어서 주변에 항상 사람이 있고, 에너지가 넘쳐서 가만히 있으면 아픈 타입이에요. 근데 뒤처리는 조금 약해요... 파이팅!',
        strengths: ['실행력', '에너지 넘침', '긍정 마인드'],
        caution: ['결과 마무리 챙기기', '번아웃 주의'],
        shareText: '내 SBTI 유형은 GOGO — 행동파래! 너는 뭐야?',
        recommendedTests: ['teto-egen-test', 'mbti-test', 'how-friends-see-me-test'],
      },
      {
        key: 'mood',
        title: 'MOOD — 감성충',
        summary: '오늘 따라 하늘이 너무 예쁘다...',
        description: '하루에 감성 3번씩 충전하는 유형. 날씨 좋으면 사진 찍고, 비 오면 에어팟 끼고 노래 듣고, 카페에서 창밖 보다가 눈물 날 뻔한 적 있음. 따뜻하고 공감 능력이 뛰어나서 친구들이 속마음을 털어놓고 싶어 하는 사람이에요. 근데 가끔 현실과 감성 사이 어딘가에서 길을 잃어요.',
        strengths: ['공감 능력 최상', '감수성 풍부', '따뜻한 사람'],
        caution: ['감성에 너무 빠지면 지침', '현실도 직시하기'],
        shareText: '내 SBTI 유형은 MOOD — 감성충이래! 너는 뭐야?',
        recommendedTests: ['love-style-test', 'attachment-style-test', 'inner-child-test'],
      },
      {
        key: 'malo',
        title: 'MALO — 환몽자',
        summary: '언젠간 되겠지... 아마도?',
        description: '머릿속에는 거대한 꿈과 계획이 있는데, 실행은... 언젠가. 따뜻하고 착하고 생각도 많은데 이상하게 실행 버튼이 잘 안 눌림. "나중에 크게 한방"을 꿈꾸는 스타일이에요. 아직 못 한 게 아니라 준비 중인 거라고 생각해요. 그 준비가 몇 년째지만요.',
        strengths: ['풍부한 상상력', '꿈이 큼', '배려심 있음'],
        caution: ['오늘 한 가지라도 실행해보기', '꿈은 실행해야 꿈'],
        shareText: '내 SBTI 유형은 MALO — 환몽자래! 너는 뭐야?',
        recommendedTests: ['inner-child-test', 'hidden-personality-test', 'teto-egen-test'],
      },
      {
        key: 'sexy',
        title: 'SEXY — 매력자',
        summary: '왜 다들 나를 좋아하지? 나도 모르겠어',
        description: '특별히 뭔가를 하지 않아도 사람들이 끌리는 유형. 걸을 때 느낌이 있고, 말할 때 뭔가 있고, 웃을 때는 더 있어요. 인싸력은 자연스럽게 따라오고, 연애 세포도 활발한 편이에요. 근데 본인은 그냥 평범하게 살고 있다고 생각함. 그게 또 매력이에요.',
        strengths: ['자연스러운 카리스마', '인싸력', '존재감'],
        caution: ['모든 관심이 좋은 건 아닐 수도', '선택적으로 에너지 써도 됨'],
        shareText: '내 SBTI 유형은 SEXY — 매력자래! 너는 뭐야?',
        recommendedTests: ['love-style-test', 'narcissist-test', 'how-friends-see-me-test'],
      },
      {
        key: 'joke-r',
        title: 'JOKE-R — 광대',
        summary: '나 진짜로 웃긴 사람이야?',
        description: '어딜 가나 분위기를 살리는 유머 담당. 진짜로 웃긴 건지 그냥 분위기가 웃긴 건지 본인도 모름. 슬플 때도 웃기려고 하고, 어색한 상황에서 개그로 풀어버리는 스타일이에요. 사실 속으로는 많은 걸 느끼는 사람인데 그냥 웃기면 됐지~ 하고 넘어가요. 광대의 눈물이에요.',
        strengths: ['분위기 메이커', '유머감각', '친화력'],
        caution: ['가끔은 진지한 감정도 표현해도 됨', '항상 웃길 필요 없음'],
        shareText: '내 SBTI 유형은 JOKE-R — 광대래! 너는 뭐야?',
        recommendedTests: ['how-friends-see-me-test', 'hidden-personality-test', 'teto-egen-test'],
      },
      {
        key: 'copy',
        title: 'COPY — 따라쟁이',
        summary: '어? 나도 그거 좋아하는데!',
        description: '주변 환경과 사람에게 굉장히 잘 적응하는 유형. 친구가 새로운 걸 좋아하면 어느 순간 나도 좋아하고 있고, 유행하는 건 따라하고 있어요. 그게 나쁜 게 아니에요 — 공감 능력이 뛰어나고 적응력이 좋은 거니까요. 근데 나만의 취향은 뭔지 한번 생각해볼 필요는 있을 것 같아요.',
        strengths: ['적응력', '공감 능력', '트렌드 감각'],
        caution: ['나만의 색깔 찾기', '유행이 아닌 진짜 내 취향 발견하기'],
        shareText: '내 SBTI 유형은 COPY — 따라쟁이래! 너는 뭐야?',
        recommendedTests: ['hidden-personality-test', 'inner-child-test', 'teto-egen-test'],
      },
      {
        key: 'diors',
        title: 'Dior-s — 화사쟁이',
        summary: '나쁘지않아~ 난 그냥 좀 멋진 것뿐',
        description: '외모와 스타일에 진심인 유형. 아침에 30분 일찍 일어나 준비하고, 옷장은 이미 쇼룸 수준이에요. SNS에는 본인 사진이 주를 이루고, 거울을 보면서 "오늘도 나쁘지 않네" 하는 사람. 사치라고요? 이건 투자예요. 자기 관리가 곧 경쟁력이니까요. 우아하게 사세요.',
        strengths: ['자기관리 철저', '트렌드 리더', '자신감'],
        caution: ['내면도 꾸미기', '외모만큼 내 정신건강도 챙기기'],
        shareText: '내 SBTI 유형은 Dior-s — 화사쟁이래! 너는 뭐야?',
        recommendedTests: ['narcissist-test', 'love-style-test', 'how-friends-see-me-test'],
      },
      {
        key: 'woci',
        title: 'WOCI — 탈관이',
        summary: '규칙? 내가 규칙이야',
        description: '정해진 틀에 적응 못 하는 자유영혼. 회사 규정은 어겼을 것 같고, 학창시절 선생님이 제일 힘들어했던 유형이에요. 근데 이상하게 결과는 괜찮게 나오는 마법... 자기만의 방식이 있고, 그 방식이 생각보다 효과적이에요. 그냥 세상이 좁은 거예요.',
        strengths: ['창의력', '자기 방식 확립', '예상 밖의 결과'],
        caution: ['최소한의 규칙은 지키기', '자유가 무례가 되지 않도록'],
        shareText: '내 SBTI 유형은 WOCI — 탈관이래! 너는 뭐야?',
        recommendedTests: ['villain-type-test', 'hidden-personality-test', 'teto-egen-test'],
      },
      {
        key: 'oj8k',
        title: 'OJ8K — 어쩌라니스',
        summary: '그래서 어쩌라고?',
        description: '기본적으로 세상사에 크게 동요하지 않는 유형. 친구가 화났을 때도 "그래서?"가 먼저 나오고, 무슨 일이 생겨도 "어쩌라는 거야"가 머릿속에 먼저 뜸. 공감 능력이 없는 게 아니라 감정 낭비를 하기 싫은 거예요. 효율 지상주의. 근데 진짜 중요한 순간에는 챙겨주는 의외의 면도 있어요.',
        strengths: ['감정 소모 없음', '현실적', '의외의 배려'],
        caution: ['가끔은 리액션 좀 해주기', '공감 표현도 연습하기'],
        shareText: '내 SBTI 유형은 OJ8K — 어쩌라니스래! 너는 뭐야?',
        recommendedTests: ['extreme-tf-test', 'hidden-personality-test', 'teto-egen-test'],
      },
      {
        key: 'drama',
        title: 'DRAMA — 드라마퀸',
        summary: '이게 보통 일이야?! 이거 완전 대박 사건이잖아!',
        description: '일상의 모든 것을 드라마로 만드는 능력자. 편의점 영수증 잘못 나왔을 때도 카오스, 카페에서 음료 틀렸을 때도 오늘의 사건. 근데 이야기하는 재주가 있어서 주변 사람이 은근히 그 이야기를 기다려요. 감정 표현이 풍부하고 따뜻하지만 간혹 주변이 지칠 수 있어요.',
        strengths: ['스토리텔링 능력', '감정 풍부', '인간미 있음'],
        caution: ['작은 일에 너무 에너지 쓰지 않기', '우선순위 정하기'],
        shareText: '내 SBTI 유형은 DRAMA — 드라마퀸이래! 너는 뭐야?',
        recommendedTests: ['love-villain-test', 'attachment-style-test', 'teto-egen-test'],
      },
      {
        key: 'save',
        title: 'SAVE — 절약왕',
        summary: '이거 좀 비싼 거 아니야?',
        description: '통장 관리 철저한 미래파 인간. 같이 밥 먹고 나서 정산 제일 빠른 사람이에요. 세일 알림은 기본이고, 적립금이 어느 정도 되면 묘하게 뿌듯함. 친구들한테는 챙겨주고 싶은데 돈이 먼저 생각남. 근데 진짜 부자는 이런 사람이 된다는 거 알고 있어요?',
        strengths: ['경제관념 뚜렷', '미래 준비', '실속형'],
        caution: ['가끔은 지금 이 순간에 투자하기', '소중한 사람에겐 씀씀이 과감해도 됨'],
        shareText: '내 SBTI 유형은 SAVE — 절약왕이래! 너는 뭐야?',
        recommendedTests: ['how-friends-see-me-test', 'love-language-test', 'teto-egen-test'],
      },
      {
        key: 'atm-er',
        title: 'ATM-er — 현금인출기',
        summary: '내가 돈 많은 줄 알아?',
        description: '주변 사람들이 당신을 ATM으로 사용하고 있음을 본인도 알고 있어요. "이번 한 번만"이 수십 번이 된 타입. 착해서 못 거절하고, 배려심이 있어서 그냥 줘버림. 근데 이제 슬슬 지치기 시작했죠? 괜찮아요 — 이제부터라도 "노(No)"를 배우면 됩니다. 당신 통장을 지키세요.',
        strengths: ['배려심', '관계를 소중히 여김', '넓은 아량'],
        caution: ['No 연습하기', '나를 이용하는 사람 구별하기'],
        shareText: '내 SBTI 유형은 ATM-er — 현금인출기래! 너는 뭐야?',
        recommendedTests: ['attachment-style-test', 'love-villain-test', 'teto-egen-test'],
      },
      {
        key: 'fake',
        title: 'FAKE — 가면인간',
        summary: '속마음은 저 멀리~',
        description: '겉으로 보이는 모습과 실제 모습이 꽤 다른 유형. 웃고 있지만 속으로는 다른 생각 하고 있고, 친한 척하지만 속마음은 잘 안 열어요. 그렇다고 나쁜 사람은 아니에요 — 자신을 보호하는 방어 메커니즘이에요. 근데 진짜 마음 열 수 있는 사람 한 명은 옆에 두세요.',
        strengths: ['TPO 완벽 적응', '눈치 빠름', '자기보호 능력'],
        caution: ['진짜 나를 표현할 공간 찾기', '마음 여는 연습'],
        shareText: '내 SBTI 유형은 FAKE — 가면인간이래! 너는 뭐야?',
        recommendedTests: ['hidden-personality-test', 'attachment-style-test', 'villain-type-test'],
      },
      {
        key: 'deny',
        title: 'DENY — 부정형',
        summary: '아니야 그거 아니야, 내 말이 맞아',
        description: '자신의 실수나 잘못을 인정하기가 유독 힘든 유형. 상황이 불리해도 이런저런 이유를 찾아내고, 틀렸어도 "그건 그때 상황이..."로 시작하는 해명이 준비되어 있어요. 자존심이 강한 거예요. 아니면 그냥 지기 싫은 거거나요. 한 번만 "내가 틀렸어"를 연습해보세요. 의외로 세상이 무너지지 않아요.',
        strengths: ['강한 자아', '포기를 모름', '자기 믿음이 강함'],
        caution: ['인정할 건 인정하기', '사과 한 마디가 관계를 살림'],
        shareText: '내 SBTI 유형은 DENY — 부정형이래! 너는 뭐야?',
        recommendedTests: ['villain-type-test', 'narcissist-test', 'teto-egen-test'],
      },
      {
        key: 'ninja',
        title: 'NINJA — 투명인간',
        summary: '나... 거기 있었는데?',
        description: '어딜 가도 존재감이 옅은 유형. 모임에 갔는데 나중에 보면 기억하는 사람이 많지 않고, 단톡방에서 발언하면 "이 사람도 있었나"가 먼저 나옴. 나쁜 게 아니에요 — 관찰력 있고, 조용히 다 보고 있는 거예요. 근데 가끔은 존재감을 드러내도 세상이 무너지지 않아요.',
        strengths: ['관찰력', '조용한 통찰력', '스트레스 없음'],
        caution: ['자기 의견 표현하기', '존재감 드러내는 연습'],
        shareText: '내 SBTI 유형은 NINJA — 투명인간이래! 너는 뭐야?',
        recommendedTests: ['hidden-personality-test', 'inner-child-test', 'teto-egen-test'],
      },
      {
        key: 'solo',
        title: 'SOLO — 독립인',
        summary: '나 혼자가 제일 편해',
        description: '혼밥, 혼술, 혼행 — 다 혼자 할 수 있고 오히려 혼자가 편한 유형. 같이 뭔가를 맞추는 과정이 에너지 소모이고, 혼자 있는 시간에서 충전이 돼요. 인싸력은 있어서 필요하면 사람들과 잘 어울리지만, 일부러 어울리지 않아도 됨. 당신의 독립성은 강점이에요.',
        strengths: ['독립심', '자립능력', '자기 페이스 유지'],
        caution: ['가끔은 연결이 힘이 됨', '혼자와 외로움은 구별하기'],
        shareText: '내 SBTI 유형은 SOLO — 독립인이래! 너는 뭐야?',
        recommendedTests: ['hidden-personality-test', 'attachment-style-test', 'teto-egen-test'],
      },
      {
        key: 'chill',
        title: 'CHILL — 무관심파',
        summary: '어... 됐어. 상관없어',
        description: '웬만한 것에는 동요하지 않는 유형. 친구가 무슨 선택을 해도 "그래 알아서 해", 무슨 일이 생겨도 "뭐 어때". 평화롭게 살고 싶은 욕구가 강하고, 갈등이나 에너지 소모를 극도로 피해요. 스트레스는 별로 없지만 주변 사람이 답답해할 수 있어요. 진짜 아무 생각 없는 건지 아니면 그냥 표현을 안 하는 건지... 본인도 가끔 모를 것 같아요.',
        strengths: ['스트레스 내성', '평온함', '갈등 없음'],
        caution: ['무관심이 방치가 되지 않도록', '가끔은 입장을 표현하기'],
        shareText: '내 SBTI 유형은 CHILL — 무관심파래! 너는 뭐야?',
        recommendedTests: ['extreme-tf-test', 'hidden-personality-test', 'teto-egen-test'],
      },
      {
        key: 'lazy',
        title: 'LAZY — 게으름뱅이',
        summary: '내일 할게. 아니 모레... 글쎄',
        description: '할 일은 많은데 몸이 안 따라주는 유형. 투두리스트 만드는 것까지는 완벽한데, 실행은 내일로 미뤄짐. 오늘 안 할 거 알면서도 일단 적어두는 그 심리... 이해해요. 침대와의 관계가 세상 그 어떤 관계보다 편안하고 안정적이에요. 근데 언젠간 해야 하는 그 일... 오늘은 아닌 것 같아요.',
        strengths: ['여유로움', '번아웃 없음', '할 때만큼은 효율 극대화'],
        caution: ['하나라도 오늘 시작하기', '미루기는 복리가 됨'],
        shareText: '내 SBTI 유형은 LAZY — 게으름뱅이래! 너는 뭐야?',
        recommendedTests: ['inner-child-test', 'hidden-personality-test', 'teto-egen-test'],
      },
    ],
    calculateResult: (scores) => {
      const ctrl = scores['ctrl'] ?? 0;
      const warm = scores['warm'] ?? 0;
      const social = scores['social'] ?? 0;
      const cL = ctrl >= 14 ? 'H' : ctrl >= 7 ? 'M' : 'L';
      const wL = warm >= 14 ? 'H' : warm >= 7 ? 'M' : 'L';
      const sL = social >= 14 ? 'H' : social >= 7 ? 'M' : 'L';
      const map: Record<string, string> = {
        'HHH': 'mum',    'HHM': 'boss',   'HHL': 'ctrl',
        'HMH': 'thank-k','HMM': 'love-r', 'HML': 'oh-no',
        'HLH': 'brag',   'HLM': 'flex',   'HLL': 'rage',
        'MHH': 'gogo',   'MHM': 'mood',   'MHL': 'malo',
        'MMH': 'sexy',   'MMM': 'joke-r', 'MML': 'copy',
        'MLH': 'diors',  'MLM': 'woci',   'MLL': 'oj8k',
        'LHH': 'drama',  'LHM': 'save',   'LHL': 'atm-er',
        'LMH': 'fake',   'LMM': 'deny',   'LML': 'ninja',
        'LLH': 'solo',   'LLM': 'chill',  'LLL': 'lazy',
      };
      return map[`${cL}${wL}${sL}`] ?? 'joke-r';
    },
  },
];
